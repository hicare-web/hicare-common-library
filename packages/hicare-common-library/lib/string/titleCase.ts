...
/**
 * input에 입려된 문자열을 타이틀 케이스로 변환합니다.
 * ex) follow step-by-step instructions => Follow Step-by-Step Instructions
 * @param {string} input The string to convert.
 * @param {Options | string[] | string} options The options object or locale string.
