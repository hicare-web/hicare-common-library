...
export const camelCase = changeKeysFactory<changeCase.PascalCaseOptions>(changeCase.camelCase);
...
export const pascalCase = changeKeysFactory<changeCase.PascalCaseOptions>(changeCase.pascalCase);
